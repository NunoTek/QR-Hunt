...
import { scanRepository } from "@server/domain/repositories/ScanRepository.js";
...
import { getLeaderboardData, invalidateLeaderboardCache } from "@server/api/routes/leaderboard.js";
